...
public class Csi {
	...
	public static void main(String[] args) throws HttpProcessException, FileNotFoundException {
		String url = "http://23zz384158.imwork.net:14667/policeHotelPerson/savePoliceHotelPerson";
...
//		
		...
		map.put("nation", "value1");
		map.put("cardNum", "value1");
		map.put("cardType", "value1");
		map.put("telephone", "value1");
		map.put("validStartDate", "value1");
		map.put("validEndDate", "value1");
		map.put("personState", "value1");
		map.put("hotelName", "value1");
		map.put("hotelArea", "value1");
		map.put("hotelAddress", "value1");
		map.put("chargePersonName", "value1");
		map.put("chargePersonPhone", "value1");
		map.put("corporationName", "value1");
		map.put("corporationCardNum", "value1");
		map.put("corporationPhone", "value1");
		map.put("carNum", "value1");
//
//		HttpClientUtil.send(config);
////		
