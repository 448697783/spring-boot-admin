...
public class Demo {
	...
	public static void main(String[] args) throws HttpProcessException, FileNotFoundException {
		String url = "http://hotel.bjcsiyun.com/hotel-server/policeHotelPerson/savePoliceHotelPerson";
		...
		json.put("cardNum","a");
		json.put("cardType","a");
		json.put("telephone","a");
		json.put("validStartDate","a");
		json.put("validEndDate","a");
		json.put("personState","a");
		json.put("carNum","a");
		json.put("hotelName","a");
		json.put("hotelArea","a");
		json.put("hotelAddress","a");
		json.put("chargePersonName","a");
		json.put("chargePersonPhone","a");
		json.put("corporationName","a");
		json.put("corporationCardNum","a");
		json.put("corporationPhone","a");
		HttpConfig json2 = HttpConfig.custom().url(url)
		.map(json);
		//最简单的使用：
		String html = HttpClientUtil.post(json2);
