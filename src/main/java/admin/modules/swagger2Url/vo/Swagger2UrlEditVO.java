 ...
 */
@ApiModel("修改参数")
public class Swagger2UrlEditVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.swagger2Url.vo.Swagger2UrlEditVO ={")
	...
	public static class Swagger2UrlEResultVO {

		private static Swagger2UrlEResultVO success = new Swagger2UrlEResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static Swagger2UrlEResultVO fail = new Swagger2UrlEResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public Swagger2UrlEResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.swagger2Url.vo.Swagger2UrlEResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public Swagger2UrlEResultVO(){
		}
		...
		public static Swagger2UrlEResultVO ok() {
			return success;
		}
	
		public static Swagger2UrlEResultVO fail() {
			return fail;
		}
