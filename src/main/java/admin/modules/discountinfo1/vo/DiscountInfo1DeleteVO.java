...
public class DiscountInfo1DeleteVO {
	...
	public static class DiscountInfo1DResultVO {

		private static DiscountInfo1DResultVO success = new DiscountInfo1DResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		private static DiscountInfo1DResultVO fail = new DiscountInfo1DResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String message;
		
		public DiscountInfo1DResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DiscountInfo1DResultVO(){
		}
		...
		public static DiscountInfo1DResultVO ok() {
			return success;
		}
	
		public static DiscountInfo1DResultVO  fail() {
			return fail;
		}
