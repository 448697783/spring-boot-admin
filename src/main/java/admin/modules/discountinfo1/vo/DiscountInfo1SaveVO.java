...
public class DiscountInfo1SaveVO {
	...
	public static class DiscountInfo1SResultVO {
		private static DiscountInfo1SResultVO fail = new DiscountInfo1SResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());

		private static DiscountInfo1SResultVO success= new DiscountInfo1SResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		...
		public DiscountInfo1SResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DiscountInfo1SResultVO(){
		}
		...
		public static DiscountInfo1SResultVO ok() {
			return success;
		}
	
		public static DiscountInfo1SResultVO  fail() {
			return fail;
		}
