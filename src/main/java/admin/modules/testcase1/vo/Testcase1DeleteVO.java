...
public class Testcase1DeleteVO {
	...
	public static class Testcase1DResultVO {
		...
		private static Testcase1DResultVO success = new Testcase1DResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		private static Testcase1DResultVO fail = new Testcase1DResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String message;
		
		public Testcase1DResultVO(String code,String message){
			this.code = code;
