 ...
 */
@ApiModel("删除测试用例参数")
public class Testcase1DeleteVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.testcase1.vo.Testcase1DeleteVO ={")
	...
	public static class Testcase1DResultVO {

		private static Testcase1DResultVO success = new Testcase1DResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static Testcase1DResultVO fail = new Testcase1DResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public Testcase1DResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.testcase1.vo.Testcase1DResultVO =")
		...
		public static Testcase1DResultVO ok() {
			return success;
		}
	
		public static Testcase1DResultVO  fail() {
			return fail;
		}
