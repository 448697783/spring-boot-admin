...
public class Testcase1SaveVO {
	...
	public static class Testcase1SResultVO {
		private static Testcase1SResultVO fail = new Testcase1SResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());

		private static Testcase1SResultVO success= new Testcase1SResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		...
		public Testcase1SResultVO(String code,String message){
			this.code = code;
