...
public class Testcase1EditVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.testcase1.vo.Testcase1EditVO ={")
	...
	public static class Testcase1EResultVO {
		...
		private static Testcase1EResultVO success = new Testcase1EResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static Testcase1EResultVO fail = new Testcase1EResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public Testcase1EResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.testcase1.vo.Testcase1EResultVO ={")
