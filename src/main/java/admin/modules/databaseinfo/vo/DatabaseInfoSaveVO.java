 ...
 */
@ApiModel("保存数据库信息表参数")
public class DatabaseInfoSaveVO {
	...
	public static class DatabaseInfoSResultVO {
		...
		public DatabaseInfoSResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DatabaseInfoSResultVO(){
		}
		...
		public static DatabaseInfoSResultVO ok() {
			return success;
		}
	
		public static DatabaseInfoSResultVO  fail() {
			return fail;
		}
