 ...
 */
@ApiModel("删除数据库信息表参数")
public class DatabaseInfoDeleteVO {
	...
	public static class DatabaseInfoDResultVO {
		...
		public DatabaseInfoDResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DatabaseInfoDResultVO(){
		}
		...
		public static DatabaseInfoDResultVO ok() {
			return success;
		}
	
		public static DatabaseInfoDResultVO  fail() {
			return fail;
		}
