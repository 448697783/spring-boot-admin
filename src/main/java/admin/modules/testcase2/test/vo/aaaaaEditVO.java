...
public class aaaaaEditVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.testcase2.test.vo.aaaaaEditVO ={")
	...
	public static class aaaaaEResultVO {

		private static aaaaaEResultVO success = new aaaaaEResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static aaaaaEResultVO fail = new aaaaaEResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public aaaaaEResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.testcase2.test.vo.aaaaaEResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public aaaaaEResultVO(){
		}
		...
		public static aaaaaEResultVO ok() {
			return success;
		}
	
		public static aaaaaEResultVO fail() {
			return fail;
		}
