...
public class aaaaaSaveVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.testcase2.test.vo.aaaaaSaveVO ={")
	...
	public static class aaaaaSResultVO {
		private static aaaaaSResultVO fail = new aaaaaSResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());

		private static aaaaaSResultVO success= new aaaaaSResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		...
		public aaaaaSResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.testcase2.test.vo.aaaaaSResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public aaaaaSResultVO(){
		}
		...
		public static aaaaaSResultVO ok() {
			return success;
		}
	
		public static aaaaaSResultVO  fail() {
			return fail;
		}
