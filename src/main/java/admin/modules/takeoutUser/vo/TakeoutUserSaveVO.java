 ...
 */
@ApiModel("保存参数")
public class TakeoutUserSaveVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.takeoutUser.vo.TakeoutUserSaveVO ={")
	...
	public static class TakeoutUserSResultVO {
		private static TakeoutUserSResultVO fail = new TakeoutUserSResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());

		private static TakeoutUserSResultVO success= new TakeoutUserSResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		...
		public TakeoutUserSResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.takeoutUser.vo.TakeoutUserSResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public TakeoutUserSResultVO(){
		}
		...
		public static TakeoutUserSResultVO ok() {
			return success;
		}
	
		public static TakeoutUserSResultVO  fail() {
			return fail;
		}
