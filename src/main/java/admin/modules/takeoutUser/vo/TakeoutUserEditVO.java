 ...
 */
@ApiModel("修改参数")
public class TakeoutUserEditVO {
	...
	public String toString(){
		...
		builder.append("admin.modules.takeoutUser.vo.TakeoutUserEditVO ={")
	...
	public static class TakeoutUserEResultVO {

		private static TakeoutUserEResultVO success = new TakeoutUserEResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static TakeoutUserEResultVO fail = new TakeoutUserEResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public TakeoutUserEResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("admin.modules.takeoutUser.vo.TakeoutUserEResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public TakeoutUserEResultVO(){
		}
		...
		public static TakeoutUserEResultVO ok() {
			return success;
		}
	
		public static TakeoutUserEResultVO fail() {
			return fail;
		}
