 ...
 */
@ApiModel("保存折扣活动信息表参数")
public class DiscountActiveInfoSaveVO {
	...
	@ApiModel("保存折扣活动信息表信息,返回执行结果")
	public static class DiscountActiveInfoSResultVO {
		private static DiscountActiveInfoSResultVO fail = new DiscountActiveInfoSResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());

		private static DiscountActiveInfoSResultVO success= new DiscountActiveInfoSResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		...
		public DiscountActiveInfoSResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DiscountActiveInfoSResultVO(){
		}
		...
		public static DiscountActiveInfoSResultVO ok() {
			return success;
		}
	
		public static DiscountActiveInfoSResultVO  fail() {
			return fail;
		}
