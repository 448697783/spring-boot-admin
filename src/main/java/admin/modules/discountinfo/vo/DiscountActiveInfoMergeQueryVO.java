package admin.modules.discountinfo.vo;
 ...
 */
@ApiModel("查询参数")
public class DiscountActiveInfoMergeQueryVO {
	...
	**/
	...
	public DiscountActiveInfoMergeQResultVO ok(List<DiscountActiveInfoMergeEntity> discountActiveInfoMergeEntityList) {
		return DiscountActiveInfoMergeQResultVO.ok(discountActiveInfoMergeEntityList,this);
	}
	@Override
	public String toString(){
		StringBuilder builder = new StringBuilder();
		builder.append("admin.entity.DiscountActiveInfoMergeEntity [")
		.append(",id=").append(id)
	...
	public static enum DiscountActiveInfoMergeEnum{
		ID("id","主键"),
		...
		DiscountActiveInfoMergeEnum(String fieldName,String remark){
	...
	@ApiModel("查询结果集")
	public static class DiscountActiveInfoMergeQResultVO {
		...
		**/
		...
		public DiscountActiveInfoMergeQResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		public DiscountActiveInfoMergeQResultVO(){
		}
		
		@ApiModelProperty(value="查询列表")
		private List<DiscountActiveInfoMergeResult> resultList;
		public DiscountActiveInfoMergeQResultVO(List<DiscountActiveInfoMergeEntity> discountActiveInfoMergeEntityList){
			this.code = ReturnMessageEnum.SUCCESS.getCode();
			this.message =ReturnMessageEnum.SUCCESS.getMessage();
			if(discountActiveInfoMergeEntityList==null||discountActiveInfoMergeEntityList.size()==0){
				return;
			}
			DiscountActiveInfoMergeResult result = null;
			resultList = new ArrayList<DiscountActiveInfoMergeResult>(discountActiveInfoMergeEntityList.size());
			for (DiscountActiveInfoMergeEntity tempEntity : discountActiveInfoMergeEntityList) {
				result = new DiscountActiveInfoMergeResult();
				BeanCopierUtils.copyProperties( tempEntity,result);
				resultList.add(result);
			}
		}
		
		public List<DiscountActiveInfoMergeResult> getResultList() {
			return resultList;
		}
		
		public void setResultList(List<DiscountActiveInfoMergeResult> resultList) {
		...
		public static DiscountActiveInfoMergeQResultVO ok(List<DiscountActiveInfoMergeEntity> discountActiveInfoMergeEntityList,DiscountActiveInfoMergeQueryVO discountActiveInfoMergeQueryVO) {
			DiscountActiveInfoMergeQResultVO discountActiveInfoMergeQResultVO = new DiscountActiveInfoMergeQResultVO(discountActiveInfoMergeEntityList);
			discountActiveInfoMergeQResultVO.setPage(discountActiveInfoMergeQueryVO.getPage());
			discountActiveInfoMergeQResultVO.setRows(discountActiveInfoMergeQueryVO.getRows());
			return discountActiveInfoMergeQResultVO;
		}
	
		public static DiscountActiveInfoMergeQResultVO  fail() {
			 DiscountActiveInfoMergeQResultVO vo = new DiscountActiveInfoMergeQResultVO(null);
	 ...
	 */
	@ApiModel("返回字段说明")
	public static class DiscountActiveInfoMergeResult {
