...
public class DiscountActiveInfoEditVO {
	...
	public static class DiscountActiveInfoEResultVO {

		private static DiscountActiveInfoEResultVO success = new DiscountActiveInfoEResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		private static DiscountActiveInfoEResultVO fail = new DiscountActiveInfoEResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String message;
		
		public DiscountActiveInfoEResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DiscountActiveInfoEResultVO(){
		}
		...
		public static DiscountActiveInfoEResultVO ok() {
			return success;
		}
	
		public static DiscountActiveInfoEResultVO fail() {
			return fail;
		}
