...
public class DiscountActiveInfoQueryVO {
	...
	**/
	...
	public String toString(){
		...
		builder.append("admin.entity.DiscountActiveInfoEntity [")
		.append(",id=").append(id)
	...
	public static enum DiscountActiveInfoEnum{
		ID("id","主键"),
		...
		DiscountActiveInfoEnum(String fieldName,String remark){
	...
	public static class DiscountActiveInfoQResultVO {
		...
		public DiscountActiveInfoQResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		public DiscountActiveInfoQResultVO(){
		}
		
		@ApiModelProperty(value="查询列表")
		private List<DiscountActiveInfoResult> resultList;
		public DiscountActiveInfoQResultVO(List<DiscountActiveInfoEntity> discountActiveInfoEntityList){
			this.code = ReturnMessageEnum.SUCCESS.getCode();
			this.message =ReturnMessageEnum.SUCCESS.getMessage();
			if(discountActiveInfoEntityList==null||discountActiveInfoEntityList.size()==0){
				return;
			}
			DiscountActiveInfoResult result = null;
			resultList = new ArrayList<DiscountActiveInfoResult>(discountActiveInfoEntityList.size());
			for (DiscountActiveInfoEntity tempEntity : discountActiveInfoEntityList) {
				result = new DiscountActiveInfoResult();
				BeanCopierUtils.copyProperties( tempEntity,result);
				resultList.add(result);
			}
		}
		
		public List<DiscountActiveInfoResult> getResultList() {
			return resultList;
		}
		
		public void setResultList(List<DiscountActiveInfoResult> resultList) {
		...
		public static DiscountActiveInfoQResultVO ok(List<DiscountActiveInfoEntity> discountActiveInfoEntityList) {
			return new DiscountActiveInfoQResultVO(discountActiveInfoEntityList);
		}
	
		public static DiscountActiveInfoQResultVO  fail() {
			 DiscountActiveInfoQResultVO vo = new DiscountActiveInfoQResultVO(null);
	...
	public static class DiscountActiveInfoResult {
