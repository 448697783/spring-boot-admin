 ...
 */
@ApiModel("删除折扣活动信息表参数")
public class DiscountActiveInfoDeleteVO {
	...
	public static class DiscountActiveInfoDResultVO {

		private static DiscountActiveInfoDResultVO success = new DiscountActiveInfoDResultVO(ReturnMessageEnum.SUCCESS.getCode(),ReturnMessageEnum.SUCCESS.getMessage());
		private static DiscountActiveInfoDResultVO fail = new DiscountActiveInfoDResultVO(ReturnMessageEnum.FAIL.getCode(),ReturnMessageEnum.FAIL.getMessage());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String message;
		
		public DiscountActiveInfoDResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public DiscountActiveInfoDResultVO(){
		}
		...
		public static DiscountActiveInfoDResultVO ok() {
			return success;
		}
	
		public static DiscountActiveInfoDResultVO  fail() {
			return fail;
		}
