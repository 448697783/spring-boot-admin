...
public class TestDeleteVO {
	...
	public static class TestDResultVO {
		...
		public TestDResultVO(String code,String message){
			this.code = code;
			this.message = message;
		}
		
		public TestDResultVO(){
		}
		...
		public static TestDResultVO ok() {
			return success;
		}
	
		public static TestDResultVO  fail() {
			return fail;
		}
